...
build_time_vars = {
    ...
    "AR": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    ...
    "LIBMPDEC_CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/Python-3.13.5/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBMPDEC_HEADERS": "\\",
    "LIBMPDEC_OBJS": "\\",
    "LIBOBJDIR": "Python/",
    "LIBOBJS": "",
    ...
    "LLVM_PROF_MERGER": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/Python-3.13.5 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/Python-3.13.5/`cat pybuilddir.txt`) /var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/tools/host/bin/python3.13",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/tools/host/bin/python3.13",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/Python-3.13.5",
    ...
    "abs_builddir": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/Python-3.13.5",
    "abs_srcdir": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpr74vs4al/Python-3.13.5",
